...
/**
 * 🔐 Unified authentication page component with modern design
 *
 * @param mode - Authentication mode: 'sign-in' or 'sign-up'
 */
      ...
      <header className="absolute top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            {/* Back to Home */}
            <Link href="/">
              <Button variant="outline" className="group hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors">
                      ...
                      appearance={{
                        elements: {
                          ...
                          socialButtonsBlockButton:
                            "border-border hover:bg-muted rounded-full transition-all duration-200",
                          formFieldInput:
